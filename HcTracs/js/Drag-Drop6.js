...
function onDrop (event){
    ...
    if(nodi[i] == 'pezzo_2'){
        ...
        x2.innerHTML= 'int i; <br> for(i=0;i<='+y+';i++){ </div>';
    ...
    if(nodi[i] == 'pezzo_3'){
        ...
        x3.innerHTML= 'number= number+number; } </div>';
    }

    i++;//incrementiamo i per il successivo id dell'elemento
    num_tentativi--;

    if(nodi[0] == 'pezzo_1' && nodi[1] == 'pezzo_2' && nodi[2]=='pezzo_3'  && y=='4'){
        console.log('vero');
        localStorage[7]='true';
    ...
    if(num_tentativi == 0 && (nodi[0] != 'pezzo_1' || nodi[1] != 'pezzo_2' || nodi[2] !='pezzo_3' || y!='4') ){

...
function onDrop (event){
    ...
    if(nodi[i] == 'pezzo_3'){
        ...
        x3.innerHTML= 'printf("the sum is %d",sum); </div>';
    }

    i++;//incrementiamo i per il successivo id dell'elemento
    num_tentativi--;

    if(nodi[0] == 'pezzo_1' && nodi[1] == 'pezzo_2' && nodi[2]=='pezzo_3'){
        console.log('vero');
        localStorage[5]='true';
    ...
    if(num_tentativi == 0 && (nodi[0] != 'pezzo_1' || nodi[1] != 'pezzo_2' || nodi[2] !='pezzo_3') ){

...
function onDrop (event){
    ...
    if(nodi[0] == 'pezzo_1' && nodi[1] == 'pezzo_2' && nodi[2]=='pezzo_3' && nodi[3]=='pezzo_4' && nodi[4]=='pezzo_5' && nodi[5]=='pezzo_6' && nodi[6]=='pezzo_7' && y1=='5' && y2=='6'){
        console.log('vero');
        localStorage[9]='true';
    ...
    if(num_tentativi == 0 && (nodi[0] != 'pezzo_1' || nodi[1] != 'pezzo_2' || nodi[2] !='pezzo_3' || nodi[3] !='pezzo_4' || nodi[4] !='pezzo_5' || nodi[5] !='pezzo_6' || nodi[6] !='pezzo_7'  || y1!='5' || y2!='6') ){
